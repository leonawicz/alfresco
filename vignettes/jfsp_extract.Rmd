...
The processing chain involes two main stages: data extraction and data curation.
...
are utilized extensively in a number of downstream SNAP projects as well as incorporation into a variety of SNAPverse data packages
